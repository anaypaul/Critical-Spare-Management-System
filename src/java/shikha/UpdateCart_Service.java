 ...
 * @author SCHOOL
 */
public class UpdateCart_Service extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>UpdateCart_Service</title>");    
...
"}"
           ...
           out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
               ...
               PreparedStatement pst_fetch=con.prepareStatement("select * from cart_service");
               ResultSet rs_fetch=pst_fetch.executeQuery();
               int a=0,b=0,c=0;
               while(rs_fetch.next())
               {
                   double total_price_double=Double.parseDouble(rs_fetch.getString(3))*Integer.parseInt(rs_fetch.getString(5));
                   String total_price=""+total_price_double;
               PreparedStatement pst_update=con.prepareStatement("insert into order_service values(?,?,?,?,?,?,?,?,?,?,?,?)");
              ...
              // pst_into_monthly_report.setString(2, new_order_date);
               ...
               PreparedStatement pst_update_cart=con.prepareStatement("update cart_service set cart_no=(?),order_date=(?) where name=(?)");
               pst_update_cart.setString(1,shopping_cart_no);
               pst_update_cart.setString(2, new_order_date);
               pst_update_cart.setString(3,rs_fetch.getString(2));
            ...
            PreparedStatement pst_display=con.prepareStatement("select * from cart_service where cart_no=(?)");
               ...
               out.println("<center>");
                       ...
                       while(rs_display.next()){
                           double total_price=Double.parseDouble(rs_display.getString(3))*Integer.parseInt(rs_display.getString(5));
                 ...
                 PreparedStatement pst_delete=con.prepareStatement("delete cart_service");
