...
public class SearchItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>SearchItem</title>");  
...
"}"
           ...
           out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                    ...
                    + "<br><br><br>");
            out.println("<h2><center>Enter Required Fields to Search</center></h2>");
            out.println("<center><form action=\"SearchItemLog\" method=\"post\">"
                    ...
                    + "<h3>OR</h3>"
                    + "<br><br>"
                    + "<b>Search by Description </b>: <input type=\"text\" name=\"description\">"
                    + "<br>"
                    + "<input type=\"submit\" value=\"Search\">"
                    + "<br><br>"
                    + "<h3>OR</h3>"
                    + "<br><br>"
                    + "<h3>Search Using The Following Fields</h3>"
                    + "<br><br>"
                    + "<table>"
                    + "<tr>"
                    + "<th>Search by category</th><td>:</td><td><select name=\"category\" id=\"category\">"
                            ...
                            + "</select></td></tr>"
                    + "<tr>"
                    + "<th>Search by Plant</th><td>:</td><td><select name=\"plant\" id=\"plant\"><br>"
                            + "<option value=\"\">null</option>"
                            + "<option value=\"37\">37</option>"
                            + "<option value=\"73\">73</option>"
                            + "</select></td></tr>"
                    + "<tr>"
                    + "<th>Search by Criticality</th><td>:</td><td><select name=\"critical\" id=\"critical\"><br>"
                            + "<option value=\"\">null</option>"
                            ...
                            + "</select></td></tr>"
                    + "<tr>"
                    + "<th>Search by Type of Product</th><td>:</td><td><select name=\"type\" id=\"type\"><br>"
                            + "<option value=\"\">null</option>"
                            + "<option value=\"Normal\">Normal</option>"
                            + "<option value=\"Insurance\">Insurance</option>"
                            + "</select></td></tr>"
                    + "<tr>"
                    + "<th>Search by Flag Colour</th><td>:</td><td><select name=\"flag_colour\" id=\"flag_colour\"><br>"
                            + "<option value=\"\">null</option>"
