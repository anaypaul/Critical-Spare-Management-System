 ...
 * @author SCHOOL
 */
public class AddCart1_Service extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>AddCart1_Service</title>");   
...
"}"
            ...
            out.println("</head>");
            out.println("<body>");
           // out.println("<h1>Servlet AddCart1_Service at " + request.getContextPath() + "</h1>");
            out.println("<br><br>");
            ...
            out.println("<center>"
                    ...
                    while(rs_fetch.next()){
                                                        out.println("<tr>"
                                                                ...
                                                                + "<td><a href=\"Remove_From_Cart_Service?description="+rs_fetch.getString(2)+" \">Remove From Cart</a></td>"  );                                                            
                                                                
                                                               out.println("</tr>");
                                                        }
                                                    out.println("</table>");
                                                    out.println(  "<form action=\"UpdateCart_Service\" method=\"post\">"
          ...
          if(request.getAttribute("msg")!=null){
            ...
            Logger.getLogger(AddCart1_Service.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
