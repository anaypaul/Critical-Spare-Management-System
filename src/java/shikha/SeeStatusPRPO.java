 ...
 * @author SCHOOL
 */
public class SeeStatusPRPO extends HttpServlet {
        ...
        try {
            ...
            if(hs==null){
                ...
                out.println("<!DOCTYPE html>");
                            out.println("<html>");
                            out.println("<head>");
                            out.println("<title>SeeStatusPRPO</title>");  
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                ...
                out.println("<center><b><font color=\"red\">"+request.getAttribute("msg")+"</font></b></center>");
                   ...
                   // out.println("shopping cart no="+shopping_cart_no);
                    ...
                    PreparedStatement pst_check=con.prepareStatement("select pr_no,pr_date,po_no,po_date,exp_delivery_date,order_date from order_prpo where shopping_cart_no=(?)");
                    ...
                    if(rs_check.next()){
                          ...
                          //  out.println("pr_no="+rs_check.getString(1)+"<br>pr_date="+rs_check.getString(2)+"<br>po_no="+rs_check.getString(3)+"<br>po_date="+rs_check.getString(4)+"<br>exp_delivery_date="+rs_check.getString(5));
                           ...
                           // out.println("<h1>Servlet SeeStatusPRPO at " + request.getContextPath() + "</h1>");
                            out.println("<center>"
                                    + "<table><form action=\"SeeStatusPRPOLog\" method=\"post\">"
                                 ...
                                 //   + "<tr><td>Order Date</td><td>:</td><td><input type=\"date\" name=\"order_date\"></td></tr>"
                                    ...
                                    + "<tr><th>Delivery Date</th><td>:</td><td><input type=\"date\" name=\"exp_delivery_date\" placeholder=\"yyyy-mm-dd(eg.2014-10-23)\"></td></tr>"
                                    ...
                                    + "</center>");
                                        ...
                                        out.println("<h3><u><b><center>DELIVERY AWAITS:</center></b></u></h3><br><br>");
                                        ...
                                        out.println("<center>"
                                             ...
                                             //   + "<tr><td>Order Date</td><td>:</td><td><input type=\"date\" name=\"order_date\"></td></tr>"
                                                + "<tr><th>PR No.</th><td>:</td><td><input type=\"text\" name=\"pr_no\" value="+rs_check.getString(1)+" readonly></td></tr>"
                                                + "<tr><th>PR Date</th><td>:</td><td><input type=\"date\" name=\"pr_date\" value="+rs_check.getString(2)+" readonly></td></tr>"
                                                + "<tr><th>PO No.</th><td>:</td><td><input type=\"text\" name=\"po_no\" value="+rs_check.getString(3)+" readonly></td></tr>"
                                                + "<tr><th>PO Date</th><td>:</td><td><input type=\"date\" name=\"po_date\" value="+rs_check.getString(4)+" readonly></td></tr>"
                                                + "<tr><th>Delivery Date</th><td>:</td><td><input type=\"date\" name=\"exp_delivery_date\" value="+rs_check.getString(5)+" readonly></td></tr>"
                                                + "</table>");
                                               // + "<tr><td colspan=3><input type=\"submit\" value=\"Submit\"></td></tr>"


                                           PreparedStatement pst_fetch=con.prepareStatement("select umc, name, order_qty, order_date, plant from order_prpo where shopping_cart_no=(?)");
                                           pst_fetch.setString(1, shopping_cart_no);
                                           ResultSet rs_fetch=pst_fetch.executeQuery();
                                           out.println("<br><br><table border='1'>");
                                        out.println("<tr><th>UMC</th>"
                                                + "<th>Decription</th>"
                                        ...
                                        String plant=null;
                                        while(rs_fetch.next()){
                                            umc=rs_fetch.getString(1);
                                            plant=rs_fetch.getString(5);
                                            out.println("<tr>"
                                                    + "<td>"+rs_fetch.getString(1)+"</td>"
                                                    + "<td>"+rs_fetch.getString(2)+"</td>"
                                                    + "<td>"+rs_fetch.getString(3)+"</td>"
                                                            + "<form action=\"ReceiveOrderPRPO\" method=\"post\">"
                                                            + "<td><input type=\"text\" name=\"received_qty\" ></td>"
                                                            + "<input type=\"hidden\" name=\"umc\" value="+rs_fetch.getString(1)+">"
                                                            + "<input type=\"hidden\" name=\"shopping_cart_no\" value="+shopping_cart_no+">"
                                                            +"<input type=\"hidden\" name=\"order_qty\" value="+rs_fetch.getString(3)+">"
                                                            +"<input type=\"hidden\" name=\"order_date\" value="+rs_fetch.getString(4)+">"
                                                            +"<input type=\"hidden\" name=\"description\" value="+rs_fetch.getString(2)+">"
                                                            +"<input type=\"hidden\" name=\"plant\" value="+rs_fetch.getString(5)+">"
                            ...
                            out.println("</table>");
                            out.println("<form action=\"CheckStatusPRPO\" method=\"post\">"
                                    + "<input type=\"hidden\" name=\"umc\" value="+umc+">"
