 ...
 * @author SCHOOL
 */
public class UpdateQty_PRPO extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
         try {
            ...
            /* TODO output your page here. You may use following sample code. */
                ...
                PreparedStatement pst_set=con.prepareStatement("update cart_prpo set order_qty=(?) where umc=(?)");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>UpdateQty_PRPO</title>");            
            out.println("</head>");
            out.println("<body>");
