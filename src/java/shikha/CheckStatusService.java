 ...
 * @author SCHOOL
 */
public class CheckStatusService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(hs==null){
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>CheckStatusService</title>");  
...
"}"
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                    ...
                    + "<br><br><br>");
                            ...
                            PreparedStatement pst_distinct=con.prepareStatement("select distinct shopping_cart_no from order_service");
                            ResultSet rs_distinct=pst_distinct.executeQuery();
                            out.println("<center>"
                                    + "<h3><u>Status of all Pending Services :-</u></h3><br><br>"
                                    + "<table border='2'>"
                                    + "<tr>"
                                    ...
                                    while(rs_distinct.next()){
                                       out.println("<tr>"
                                               + "<td align=\"center\"><a href=\"SeeStatusService?shopping_cart_no="+rs_distinct.getString(1)+"\">"+rs_distinct.getString(1)+"</a></td>"
                                               + "<td>");
                                ...
                                out.println("<table border='1'><tr>"
                                        ...
                                        PreparedStatement pst_details=con.prepareStatement("select * from order_service where shopping_cart_no=(?)");
                             ...
                             // if(rs_details.next()){
                                        ...
                                        out.println("</table></td>");
                                         ...
                                         PreparedStatement pst_distinct2=con.prepareStatement("select order_date from order_service where shopping_cart_no=(?)");
                                        ...
                                        PreparedStatement pst_check=con.prepareStatement("select exp_delivery_date from order_service where exp_delivery_date<sysdate and shopping_cart_no=(?)");
                                        pst_check.setString(1, rs_distinct.getString(1));
                                        
                                        ResultSet rs_check=pst_check.executeQuery();
                                        if(rs_check.next()){
                                            out.println("<td bgcolor=\"red\" align=\"center\">Expected Job Completion Date Expired</td>");
                                        }
