...
public class ServiceOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>ServiceOrder</title>");   
...
"}"
            ...
            out.println("<center>");
                    ...
                    out.println("<form action=\"AddCart1_Service\" method=\"post\">"
                    ...
                    + "<form action=\"AddCart_Service\" method=\"post\">"
                   // + "<tr><td>Shopping Cart No.</td><td>:</td><td><input type=\"text\" name=\"shopping_cart_no\"></td></tr>"
                    + "<tr><th>Description</th><td>:</td><td><input type=\"text\" name=\"description\"></td></tr>"
                   // + "<tr><td>Order Date</td><td>:</td><td><input type=\"date\" name=\"order_date\"></td></tr>"
                    + "<tr><th>Order Quantity</th><td>:</td><td><input type=\"text\" name=\"order_qty\"></td></tr>"
                    + "<tr><th>Unit Price</th><td>:</td><td><input type=\"text\" name=\"unit_price\"></td></tr>"
                    + "<tr><td colspan='3' align='center'><input type=\"submit\" value=\"Add to Cart\"></td></tr>"
                    + "</form>"
