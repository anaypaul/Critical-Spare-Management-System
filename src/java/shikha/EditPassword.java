...
public class EditPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>EditPassword</title>");   
            out.println("<style>"
...
"}"
            ...
            PreparedStatement pst_check=con.prepareStatement("select utype from login_sms where username=(?)");
                pst_check.setString(1,nm);
                ResultSet rs_check=pst_check.executeQuery();
                if(rs_check.next()){
                            if(rs_check.getString(1).equals("admin")){
                            out.println("<br><br>");
                    ...
                    + "<br><br><br>");
                            ...
                            out.println("<center>"
                                    + "<h3><u>EDIT PASSWORD</u></h3>"
                                    + "<br><br>"
                                    + "<table>");
                            out.println("<form action=\"EditPasswordLog\" method=\"post\">"
                                    + "<tr>"
                                    + "<td><b>Current Password</b></td><td>:</td><td><input type=\"password\" name=\"password_old\"><font color=\"#FF0000\">*</font></td>"
                                    + "</tr>"
                                    + "<tr>"
                                    + "<td><b>New Password</b></td><td>:</td><td><input type=\"password\" name=\"password_new\"><font color=\"#FF0000\">*</font></td>"
                                    + "</tr>"
                                    + "<tr>"
                                    + "<td><b>Re-enter New Password</b></td><td>:</td><td><input type=\"password\" name=\"password_re_new\"><font color=\"#FF0000\">*</font></td>"
                                    + "</tr>"
                                    + "<tr>"
