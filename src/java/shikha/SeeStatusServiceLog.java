 ...
 * @author SCHOOL
 */
public class SeeStatusServiceLog extends HttpServlet {
                ...
                response.sendRedirect("loginpage");
                    ...
                    Connection con = Service.getConnection();
                     ...
                     if(pr_date!="" && po_date=="" && exp_delivery_date==""){  
                        ...
                        PreparedStatement pst_update=con.prepareStatement("update order_service set pr_no=(?),pr_date=(?),po_no=(?),po_date=(?),exp_delivery_date=(?) where shopping_cart_no=(?)");
                    ...
                    if(a<0){
                        ...
                        rd.forward(request, response);
                            ...
                            out.println("<html>");
                            out.println("<head>");
                            out.println("<title>SeeStatusServiceLog</title>");
                            out.println("</head>");
                            out.println("<body>");
