...
public class UserManager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>UserManager</title>");
...
"}"
            ...
            PreparedStatement pst=con.prepareStatement("select * from rq_sms order by status");
            ResultSet rs=pst.executeQuery();
            
            out.println("<br><br><br>"
                    + "<center><u><h2>USER REQUEST MANAGER</h2></u><br><br>");
            ...
            out.println("<br><table border='1'>"
                    + "<tr><th>Username</th><th>Status</th><th>Name</th><th>Action</th></tr>");
            while(rs.next()){
                out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td><a href=\"UserManagerLog?us="+rs.getString(1)+"\">Verify</a>&nbsp;&nbsp;&nbsp;<a href=\"UserManagerLog1?us="+rs.getString(1)+"\">Reject</a></td></tr>");
            }
            out.println("</table>"
                    + "</center>");
            out.println("</body>");
