 ...
 * @author SCHOOL
 */
public class AddCart_PRPO extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>AddCart_PRPO</title>");  
            ...
            PreparedStatement pst_insert=con.prepareStatement("insert into cart_prpo values(?,?,?,?,?,?,?,?,?,?)");
            ...
            if(a<0){
                ...
                RequestDispatcher rd = request.getRequestDispatcher("PRPOLog");
            ...
            Logger.getLogger(AddCart_PRPO.class.getName()).log(Level.SEVERE, null, ex);
        }
         finally {
            out.close();
        }
