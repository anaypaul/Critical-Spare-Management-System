...
public class AddCart1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>AddCart1</title>");  
...
"}"
            ...
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet AddCart1 at " + request.getContextPath() + "</h1>");
            ...
            out.println("<center>"
                    ...
                    while(rs_fetch.next()){
                                                        out.println("<tr>"
                                                                ...
                                                                +"<td><form action=\"UpdateQty73\" method=\"post\"><input type=\"text\" name=\"order_qty\" value="+rs_fetch.getString(7)+"></td>"
                                                                + "<input type=\"hidden\" name=\"umc\" value="+rs_fetch.getString(2)+">"
                                                                +"<td><input type=\"submit\" value=\"Update Quantity\"></td>"
                                                                + "</form>"
                                                                + "<td><a href=\"Remove_From_Cart?umc="+rs_fetch.getString(2)+" \">Remove From Cart</a></td>"  );                                                            
                                                    ...
                                                    out.println(  "<form action=\"UpdateCart\" method=\"post\">"
                                                            ...
                                                            + "Reservation No. : <input type=\"text\" name=\"reservation_no\" > "
          ...
          if(request.getAttribute("msg")!=null){
            ...
            Logger.getLogger(AddCart1.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
