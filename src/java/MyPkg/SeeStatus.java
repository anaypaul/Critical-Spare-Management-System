 ...
 * @author SCHOOL
 */
public class SeeStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            /* TODO output your page here. You may use following sample code. */
                    ...
                    out.println("<html>");
                    out.println("<head>");
                    out.println("<title>SeeStatus</title>"); 
...
"}"
                    ...
                    out.println("</head>");
                    out.println("<body>");
                    //out.println("<h1>Servlet SeeStatus at " + request.getContextPath() + "</h1>");
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                ...
                out.println("<center><b><font color=\"red\">"+request.getAttribute("msg")+"</font></b></center>");
                    ...
                    PreparedStatement pst_fetch=con.prepareStatement("select * from order73 where shopping_cart_no=(?)");
                    pst_fetch.setString(1,shopping_cart_no);
                    ResultSet rs_fetch=pst_fetch.executeQuery();
                    out.println("<br><br><center>"
                            + "<h3>Shopping Cart Number = "+shopping_cart_no+"</h3><br><br>");
                    ...
                    String reservation_no=null;
                            ...
                            out.println("<tr><th>UMC</th>"
                                    ...
                                    + "<tr>");
                            while(rs_fetch.next()){
                                umc=rs_fetch.getString(3);
                                order_qty=rs_fetch.getString(5);
                                plant=rs_fetch.getString(9);
                                order_date=rs_fetch.getString(2);
                                description=rs_fetch.getString(4);
                                reservation_no=rs_fetch.getString(8);
                                ...
                                out.println("<tr>"
                                        ...
                                        + "<td>"+rs_fetch.getString(5)+"</td>"
                                                ...
                                                + "<td><input type=\"date\" name=\"received_date\" placeholder=\"yyyy-mm-dd(eg.2014-10-23)\"></td>"
                    ...
                    out.println("</table><br><br>");
                      out.println("<form action=\"CheckStatus\" method=\"post\">"
                      + "<input type=\"hidden\" name=\"umc\" value="+umc+" >"
                      + "<input type=\"hidden\" name=\"plant\" value="+plant+">");
                    out.println("<input type=\"submit\" value=\"Update order\">");
            ...
            Logger.getLogger(SeeStatus.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
