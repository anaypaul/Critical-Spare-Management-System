 ...
 * @author SCHOOL
 */
public class CheckStatusPRPO extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(hs==null){
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>CheckStatusPRPO</title>"); 
...
"}"
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                    ...
                    + "<br><br><br>");
                            ...
                            PreparedStatement pst_distinct=con.prepareStatement("select distinct shopping_cart_no from order_prpo where plant=(?)");
                            pst_distinct.setString(1,plant);
                            ResultSet rs_distinct=pst_distinct.executeQuery();
                            out.println("<center>"
                                    + "<h3><u>Status of all Pending PR_PO's :-</u></h3><br><br>"
                                    + "<table border='2'>"
                                    + "<tr>"
                                    ...
                                    + "<th>Order Date</th>"
                                    + "<th>Warning for Late Delivery</th>");
                            
                                    while(rs_distinct.next()){
                                        
                                       out.println("<tr>"
                                               + "<td align=\"center\"><a href=\"SeeStatusPRPO?shopping_cart_no="+rs_distinct.getString(1)+"\">"+rs_distinct.getString(1)+"</a></td>"
                                               + "<td>");
                                ...
                                out.println("<table border='1'><tr>"
                                        ...
                                        PreparedStatement pst_details=con.prepareStatement("select * from order_prpo where shopping_cart_no=(?) and plant=(?)");
                             ...
                             // if(rs_details.next()){
                                        while(rs_details.next()){
                                                out.println("<tr>"
                                                        ...
                                                        + "<td>"+plant+"</td>"
                                                        + "<td>"+rs_details.getString(8)+"</td>"
                                                        + "<td>"+rs_details.getString(9)+"</td>"
                                                        + "<td>"+rs_details.getString(10)+"</td>"

                                                        + "</tr>"
                                                        );
                                        }
                                        out.println("</table></td>");
                                       /* PreparedStatement pst_distinct1=con.prepareStatement("select distinct reservation_no from order73");
                                        ...
                                        out.println("<td align='center'>"+rs_distinct1.getString(1)+"</td>");
                                         ...
                                         PreparedStatement pst_distinct2=con.prepareStatement("select order_date from order_prpo where shopping_cart_no=(?)");
                                        ...
                                        PreparedStatement pst_check=con.prepareStatement("select exp_delivery_date from order_prpo where exp_delivery_date<sysdate and shopping_cart_no=(?) and plant=(?)");
                                        pst_check.setString(1, rs_distinct.getString(1));
                                        pst_check.setString(2, plant);
                                        ResultSet rs_check=pst_check.executeQuery();
                                        if(rs_check.next()){
                                            out.println("<td bgcolor=\"red\" align=\"center\">LATE DELIVERY</td>");
                                        }
                        out.println("</tr>");
                // }
                          /*    else{
