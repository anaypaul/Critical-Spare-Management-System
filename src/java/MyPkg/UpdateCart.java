...
public class UpdateCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>UpdateCart</title>");  
...
"}"
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
               ...
               PreparedStatement pst_fetch=con.prepareStatement("select * from cart");
               ...
               PreparedStatement pst_update=con.prepareStatement("insert into order73 values(?,?,?,?,?,?,?,?,?,?)");
            ...
            PreparedStatement pst_display=con.prepareStatement("select * from cart where cart_no=(?)");
               pst_display.setString(1,shopping_cart_no);
               ResultSet rs_display=pst_display.executeQuery();
                
               out.println("<center>");
                      
                       out.println("<br><b>Shopping Cart No : <input type=\"text\" name=\"shopping_cart_no\" value="+shopping_cart_no+" readonly><b>"
                       + "<br><br><b>Order Date : <input type=\"text\" name=\"order_date\" value="+new_order_date+" readonly><b>");
                        out.println("<br><br><table border='1' cellspacing='1'>"
                                                                + "<tr>"
                       ...
                       while(rs_display.next()){
                           double total_price=Double.parseDouble(rs_display.getString(9))*Integer.parseInt(rs_display.getString(7));
                 ...
                 PreparedStatement pst_delete=con.prepareStatement("delete cart");
