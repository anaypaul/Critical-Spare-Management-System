 ...
 * @author SCHOOL
 */
public class CheckStatusSelect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(hs==null){
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>CheckStatusSelect</title>");
...
"}"
                ...
                out.println("</head>");
                out.println("<body>");
               // out.println("<h1>Servlet CheckStatusSelect at " + request.getContextPath() + "</h1>");
                   out.println("<br><br>");
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                    ...
                    + "<br><br><br>");
                           ...
                           + "<h3>Check Status for Reservations for Plant No.<select name=\"plant\" id=\"plant\">"
                           ...
                           + "<form action=\"CheckStatusPRPO\" method=\"post\">"
                           + "<h3>Check Status for PR_PO's for Plant No.<select name=\"plant\" id=\"plant\">"
                           + "<option value=\"37\">37</option>"
                           + "<option value=\"26\">26</option>"
                           + "<option value=\"27\">27</option>"
                           + "</select>"
                           ...
                           + "<br><br><br>"
                           + "<h3><a href=\"CheckStatusService\">Check Status for Service</a></h3>"
