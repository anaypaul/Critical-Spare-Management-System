 ...
 * @author SCHOOL
 */
public class User_IssueProducts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>User_IssueProducts</title>");       
...
"}"
            ...
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet User_IssueProducts at " + request.getContextPath() + "</h1>");
            out.print("<br><br>"
                                    ...
                                    + "<br><br><br>");
           // out.println("<h3>Search for the product</h3>");
            
            out.println("<h3><center>Enter Required Fields to Search</center></h3><br><br>");
            
            out.println("<center><form action=\"User_SearchItemLog\" method=\"post\">"
                    + "<b>Search by Umc</b>:<input type=\"text\" name=\"umc\">"
                    + "<br>"
                    + "<input type=\"submit\" value=\"Search\">"
                    + "<br><br>"
                    + "<h3>OR</h3><br><br>"
                    + "<h3>Search Using The Following Fields</h3><br><br>"
                    + "<b>Search by category</b>:<select name=\"category\" id=\"category\">"
                            ...
                            + "</select>"
                    + "<br><br><br>"
                    + "<b>Search by Plant</b>:<select name=\"plant\" id=\"plant\"><br>"
                            + "<option value=\"\">null</option>"
                            + "<option value=\"37\">37</option>"
                            + "<option value=\"73\">73</option>"
                            + "</select>"
                    + "<br><br><br>"
                    + "<b>Search by Criticality</b>:<select name=\"critical\" id=\"critical\"><br>"
                            + "<option value=\"\">null</option>"
                            ...
                            + "</select>"
                    + "<br><br><br>"
                    + "<b>Search by Type of Product</b>:<select name=\"type\" id=\"type\"><br>"
                            + "<option value=\"\">null</option>"
