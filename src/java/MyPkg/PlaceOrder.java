...
public class PlaceOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>PlaceOrder</title>"); 
...
"}"
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                    ...
                    +"<form action=\"PlaceOrderLog73\" method=\"post\">"
                    + "<h3>Place Order for<select name=\"plant\" id=\"plant\">"
                    + "<option value=\"37\">37</option>"
                    + "<option value=\"73\">73</option>"
                    + "<option value=\"26\">26</option>"
                    + "<option value=\"27\">27</option> Item</h3>"
                    + "<input type=\"submit\" value=\"Submit\">"
                    + "</form>"
                    + "<br><br><br><br><br><br>"
                    + "<a href=\"ServiceOrder\"><h3>Place Order for Service</h3></a>"
                    + "</center>");
            out.println("</body>");
            out.println("</html>");
            }
