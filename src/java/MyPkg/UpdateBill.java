        ...
        try {
            ...
            if(hs==null){
                response.sendRedirect("loginpage");
                        ...
                        out.println("<html>");
                        out.println("<head>");
                        out.println("<title>UpdateBill</title>");   
...
"}"
            ...
            out.print("<center><a href=\"adminHome\"><h4>HOME</a>&nbsp;<font color='RED'>||</font>&nbsp;"
                ...
                out.println("<center><b><font color=\"red\">"+request.getAttribute("msg")+"</font></b></center>");
                        ...
                        PreparedStatement pst=con.prepareStatement("select * from bills where total_value_bal=0");
                        ...
                        while(rs.next()){
                            out.println("<tr>"
                                    ...
                                    + "<td><a href=\"UpdateBillLog?bill_ref_no="+rs.getString(3)+"&total_value_wt="+rs.getString(11)+"\">Job Done</a></td><td><a href=\"RemoveBill?bill_ref_no="+rs.getString(3)+"\">Remove</a></td>"
                                    + "</tr>");
                        }
                        out.println("</table>");
                        out.println("</body>");
